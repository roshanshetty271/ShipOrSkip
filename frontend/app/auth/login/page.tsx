  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <button onClick={handleGoogleLogin} className="btn-secondary w-full mb-4">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center"><span className="bg-white px-3 text-2xs text-ink-300 uppercase tracking-wider">or</span></div>
        </div>
        ...
        <p className="text-center text-sm text-ink-400 mt-6">
          No account? <Link href="/auth/signup" className="text-ink underline underline-offset-4">Sign up</Link>
        </p>
      </div>
    </div>
  );
